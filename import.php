...
<fieldset>
	...
	<body>
		...
		if($_GET["tabid"]==NULL){
			...
			echo "<h3 class='label success'>These Following Student Records Were Recognized Submit To Import <input type='submit' style='height:20%' class='btn primary' value='Submit'></input></h3>";
			echo "";
			echo "<table class='bttable'>";
